...
def Z3_global_param_set(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_global_param_set is None:
     return
  _lib.Z3_global_param_set(_to_ascii(a0), _to_ascii(a1))

def Z3_global_param_reset_all():
  _lib = lib()
  if _lib is None or _lib.Z3_global_param_reset_all is None:
     return
  _lib.Z3_global_param_reset_all()

def Z3_global_param_get(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_global_param_get is None:
     return
  r = _lib.Z3_global_param_get(_to_ascii(a0), _to_ascii(a1))
  return r

def Z3_mk_config():
  _lib = lib()
  if _lib is None or _lib.Z3_mk_config is None:
     return
  r = _lib.Z3_mk_config()
  return r
...
def Z3_del_config(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_del_config is None:
     return
  _lib.Z3_del_config(a0)

def Z3_set_param_value(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_set_param_value is None:
     return
  _lib.Z3_set_param_value(a0, _to_ascii(a1), _to_ascii(a2))

def Z3_mk_context(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_context is None:
     return
  r = _lib.Z3_mk_context(a0)
  return r

def Z3_mk_context_rc(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_context_rc is None:
     return
  r = _lib.Z3_mk_context_rc(a0)
  return r

def Z3_del_context(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_del_context is None:
     return
  _lib.Z3_del_context(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))

def Z3_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_inc_ref is None:
     return
  _lib.Z3_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_dec_ref is None:
     return
  _lib.Z3_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_update_param_value(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_update_param_value is None:
     return
  _lib.Z3_update_param_value(a0, _to_ascii(a1), _to_ascii(a2))
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_interrupt(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_interrupt is None:
     return
  _lib.Z3_interrupt(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_mk_params(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_params is None:
     return
  r = _lib.Z3_mk_params(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_params_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_params_inc_ref is None:
     return
  _lib.Z3_params_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_params_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_params_dec_ref is None:
     return
  _lib.Z3_params_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_params_set_bool(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_params_set_bool is None:
     return
  _lib.Z3_params_set_bool(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_params_set_uint(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_params_set_uint is None:
     return
  _lib.Z3_params_set_uint(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_params_set_double(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_params_set_double is None:
     return
  _lib.Z3_params_set_double(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_params_set_symbol(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_params_set_symbol is None:
     return
  _lib.Z3_params_set_symbol(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_params_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_params_to_string is None:
     return
  r = _lib.Z3_params_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_params_validate(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_params_validate is None:
     return
  _lib.Z3_params_validate(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_param_descrs_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_param_descrs_inc_ref is None:
     return
  _lib.Z3_param_descrs_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_param_descrs_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_param_descrs_dec_ref is None:
     return
  _lib.Z3_param_descrs_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_param_descrs_get_kind(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_param_descrs_get_kind is None:
     return
  r = _lib.Z3_param_descrs_get_kind(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_param_descrs_size(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_param_descrs_size is None:
     return
  r = _lib.Z3_param_descrs_size(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_param_descrs_get_name(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_param_descrs_get_name is None:
     return
  r = _lib.Z3_param_descrs_get_name(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_param_descrs_get_documentation(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_param_descrs_get_documentation is None:
     return
  r = _lib.Z3_param_descrs_get_documentation(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_param_descrs_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_param_descrs_to_string is None:
     return
  r = _lib.Z3_param_descrs_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_mk_int_symbol(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_int_symbol is None:
     return
  r = _lib.Z3_mk_int_symbol(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_string_symbol(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_string_symbol is None:
     return
  r = _lib.Z3_mk_string_symbol(a0, _to_ascii(a1))
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_uninterpreted_sort(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_uninterpreted_sort is None:
     return
  r = _lib.Z3_mk_uninterpreted_sort(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bool_sort(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bool_sort is None:
     return
  r = _lib.Z3_mk_bool_sort(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_int_sort(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_int_sort is None:
     return
  r = _lib.Z3_mk_int_sort(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_real_sort(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_real_sort is None:
     return
  r = _lib.Z3_mk_real_sort(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bv_sort(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bv_sort is None:
     return
  r = _lib.Z3_mk_bv_sort(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_finite_domain_sort(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_finite_domain_sort is None:
     return
  r = _lib.Z3_mk_finite_domain_sort(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_array_sort(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_array_sort is None:
     return
  r = _lib.Z3_mk_array_sort(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_tuple_sort(a0, a1, a2, a3, a4, a5, a6):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_tuple_sort is None:
     return
  r = _lib.Z3_mk_tuple_sort(a0, a1, a2, a3, a4, a5, a6)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_enumeration_sort(a0, a1, a2, a3, a4, a5):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_enumeration_sort is None:
     return
  r = _lib.Z3_mk_enumeration_sort(a0, a1, a2, a3, a4, a5)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_list_sort(a0, a1, a2, a3, a4, a5, a6, a7, a8):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_list_sort is None:
     return
  r = _lib.Z3_mk_list_sort(a0, a1, a2, a3, a4, a5, a6, a7, a8)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_constructor(a0, a1, a2, a3, a4, a5, a6):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_constructor is None:
     return
  r = _lib.Z3_mk_constructor(a0, a1, a2, a3, a4, a5, a6)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_del_constructor(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_del_constructor is None:
     return
  _lib.Z3_del_constructor(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_mk_datatype(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_datatype is None:
     return
  r = _lib.Z3_mk_datatype(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_constructor_list(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_constructor_list is None:
     return
  r = _lib.Z3_mk_constructor_list(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_del_constructor_list(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_del_constructor_list is None:
     return
  _lib.Z3_del_constructor_list(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_mk_datatypes(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_datatypes is None:
     return
  _lib.Z3_mk_datatypes(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_query_constructor(a0, a1, a2, a3, a4, a5):
  _lib = lib()
  if _lib is None or _lib.Z3_query_constructor is None:
     return
  _lib.Z3_query_constructor(a0, a1, a2, a3, a4, a5)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_mk_func_decl(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_func_decl is None:
     return
  r = _lib.Z3_mk_func_decl(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_app(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_app is None:
     return
  r = _lib.Z3_mk_app(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_const(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_const is None:
     return
  r = _lib.Z3_mk_const(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fresh_func_decl(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fresh_func_decl is None:
     return
  r = _lib.Z3_mk_fresh_func_decl(a0, _to_ascii(a1), a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fresh_const(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fresh_const is None:
     return
  r = _lib.Z3_mk_fresh_const(a0, _to_ascii(a1), a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_true(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_true is None:
     return
  r = _lib.Z3_mk_true(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_false(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_false is None:
     return
  r = _lib.Z3_mk_false(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_eq(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_eq is None:
     return
  r = _lib.Z3_mk_eq(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_distinct(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_distinct is None:
     return
  r = _lib.Z3_mk_distinct(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_not(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_not is None:
     return
  r = _lib.Z3_mk_not(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_ite(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_ite is None:
     return
  r = _lib.Z3_mk_ite(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_iff(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_iff is None:
     return
  r = _lib.Z3_mk_iff(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_implies(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_implies is None:
     return
  r = _lib.Z3_mk_implies(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_xor(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_xor is None:
     return
  r = _lib.Z3_mk_xor(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_and(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_and is None:
     return
  r = _lib.Z3_mk_and(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_or(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_or is None:
     return
  r = _lib.Z3_mk_or(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_add(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_add is None:
     return
  r = _lib.Z3_mk_add(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_mul(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_mul is None:
     return
  r = _lib.Z3_mk_mul(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_sub(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_sub is None:
     return
  r = _lib.Z3_mk_sub(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_unary_minus(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_unary_minus is None:
     return
  r = _lib.Z3_mk_unary_minus(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_div(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_div is None:
     return
  r = _lib.Z3_mk_div(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_mod(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_mod is None:
     return
  r = _lib.Z3_mk_mod(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_rem(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_rem is None:
     return
  r = _lib.Z3_mk_rem(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_power(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_power is None:
     return
  r = _lib.Z3_mk_power(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_lt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_lt is None:
     return
  r = _lib.Z3_mk_lt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_le(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_le is None:
     return
  r = _lib.Z3_mk_le(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_gt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_gt is None:
     return
  r = _lib.Z3_mk_gt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_ge(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_ge is None:
     return
  r = _lib.Z3_mk_ge(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_int2real(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_int2real is None:
     return
  r = _lib.Z3_mk_int2real(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_real2int(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_real2int is None:
     return
  r = _lib.Z3_mk_real2int(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_is_int(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_is_int is None:
     return
  r = _lib.Z3_mk_is_int(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvnot(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvnot is None:
     return
  r = _lib.Z3_mk_bvnot(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvredand(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvredand is None:
     return
  r = _lib.Z3_mk_bvredand(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvredor(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvredor is None:
     return
  r = _lib.Z3_mk_bvredor(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvand(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvand is None:
     return
  r = _lib.Z3_mk_bvand(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvor(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvor is None:
     return
  r = _lib.Z3_mk_bvor(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvxor(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvxor is None:
     return
  r = _lib.Z3_mk_bvxor(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvnand(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvnand is None:
     return
  r = _lib.Z3_mk_bvnand(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvnor(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvnor is None:
     return
  r = _lib.Z3_mk_bvnor(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvxnor(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvxnor is None:
     return
  r = _lib.Z3_mk_bvxnor(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvneg(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvneg is None:
     return
  r = _lib.Z3_mk_bvneg(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvadd(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvadd is None:
     return
  r = _lib.Z3_mk_bvadd(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvsub(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvsub is None:
     return
  r = _lib.Z3_mk_bvsub(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvmul(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvmul is None:
     return
  r = _lib.Z3_mk_bvmul(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvudiv(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvudiv is None:
     return
  r = _lib.Z3_mk_bvudiv(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvsdiv(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvsdiv is None:
     return
  r = _lib.Z3_mk_bvsdiv(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvurem(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvurem is None:
     return
  r = _lib.Z3_mk_bvurem(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvsrem(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvsrem is None:
     return
  r = _lib.Z3_mk_bvsrem(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvsmod(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvsmod is None:
     return
  r = _lib.Z3_mk_bvsmod(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvult(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvult is None:
     return
  r = _lib.Z3_mk_bvult(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvslt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvslt is None:
     return
  r = _lib.Z3_mk_bvslt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvule(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvule is None:
     return
  r = _lib.Z3_mk_bvule(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvsle(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvsle is None:
     return
  r = _lib.Z3_mk_bvsle(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvuge(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvuge is None:
     return
  r = _lib.Z3_mk_bvuge(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvsge(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvsge is None:
     return
  r = _lib.Z3_mk_bvsge(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvugt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvugt is None:
     return
  r = _lib.Z3_mk_bvugt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvsgt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvsgt is None:
     return
  r = _lib.Z3_mk_bvsgt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_concat(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_concat is None:
     return
  r = _lib.Z3_mk_concat(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_extract(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_extract is None:
     return
  r = _lib.Z3_mk_extract(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_sign_ext(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_sign_ext is None:
     return
  r = _lib.Z3_mk_sign_ext(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_zero_ext(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_zero_ext is None:
     return
  r = _lib.Z3_mk_zero_ext(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_repeat(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_repeat is None:
     return
  r = _lib.Z3_mk_repeat(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvshl(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvshl is None:
     return
  r = _lib.Z3_mk_bvshl(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvlshr(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvlshr is None:
     return
  r = _lib.Z3_mk_bvlshr(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvashr(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvashr is None:
     return
  r = _lib.Z3_mk_bvashr(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_rotate_left(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_rotate_left is None:
     return
  r = _lib.Z3_mk_rotate_left(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_rotate_right(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_rotate_right is None:
     return
  r = _lib.Z3_mk_rotate_right(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_ext_rotate_left(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_ext_rotate_left is None:
     return
  r = _lib.Z3_mk_ext_rotate_left(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_ext_rotate_right(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_ext_rotate_right is None:
     return
  r = _lib.Z3_mk_ext_rotate_right(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_int2bv(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_int2bv is None:
     return
  r = _lib.Z3_mk_int2bv(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bv2int(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bv2int is None:
     return
  r = _lib.Z3_mk_bv2int(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvadd_no_overflow(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvadd_no_overflow is None:
     return
  r = _lib.Z3_mk_bvadd_no_overflow(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvadd_no_underflow(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvadd_no_underflow is None:
     return
  r = _lib.Z3_mk_bvadd_no_underflow(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvsub_no_overflow(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvsub_no_overflow is None:
     return
  r = _lib.Z3_mk_bvsub_no_overflow(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvsub_no_underflow(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvsub_no_underflow is None:
     return
  r = _lib.Z3_mk_bvsub_no_underflow(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvsdiv_no_overflow(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvsdiv_no_overflow is None:
     return
  r = _lib.Z3_mk_bvsdiv_no_overflow(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvneg_no_overflow(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvneg_no_overflow is None:
     return
  r = _lib.Z3_mk_bvneg_no_overflow(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvmul_no_overflow(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvmul_no_overflow is None:
     return
  r = _lib.Z3_mk_bvmul_no_overflow(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bvmul_no_underflow(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bvmul_no_underflow is None:
     return
  r = _lib.Z3_mk_bvmul_no_underflow(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_select(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_select is None:
     return
  r = _lib.Z3_mk_select(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_store(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_store is None:
     return
  r = _lib.Z3_mk_store(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_const_array(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_const_array is None:
     return
  r = _lib.Z3_mk_const_array(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_map(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_map is None:
     return
  r = _lib.Z3_mk_map(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_array_default(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_array_default is None:
     return
  r = _lib.Z3_mk_array_default(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_set_sort(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_set_sort is None:
     return
  r = _lib.Z3_mk_set_sort(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_empty_set(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_empty_set is None:
     return
  r = _lib.Z3_mk_empty_set(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_full_set(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_full_set is None:
     return
  r = _lib.Z3_mk_full_set(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_set_add(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_set_add is None:
     return
  r = _lib.Z3_mk_set_add(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_set_del(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_set_del is None:
     return
  r = _lib.Z3_mk_set_del(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_set_union(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_set_union is None:
     return
  r = _lib.Z3_mk_set_union(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_set_intersect(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_set_intersect is None:
     return
  r = _lib.Z3_mk_set_intersect(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_set_difference(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_set_difference is None:
     return
  r = _lib.Z3_mk_set_difference(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_set_complement(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_set_complement is None:
     return
  r = _lib.Z3_mk_set_complement(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_set_member(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_set_member is None:
     return
  r = _lib.Z3_mk_set_member(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_set_subset(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_set_subset is None:
     return
  r = _lib.Z3_mk_set_subset(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_array_ext(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_array_ext is None:
     return
  r = _lib.Z3_mk_array_ext(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_numeral(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_numeral is None:
     return
  r = _lib.Z3_mk_numeral(a0, _to_ascii(a1), a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_real(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_real is None:
     return
  r = _lib.Z3_mk_real(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_int(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_int is None:
     return
  r = _lib.Z3_mk_int(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_unsigned_int(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_unsigned_int is None:
     return
  r = _lib.Z3_mk_unsigned_int(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_int64(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_int64 is None:
     return
  r = _lib.Z3_mk_int64(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_unsigned_int64(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_unsigned_int64 is None:
     return
  r = _lib.Z3_mk_unsigned_int64(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_sort(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_sort is None:
     return
  r = _lib.Z3_mk_seq_sort(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_seq_sort(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_is_seq_sort is None:
     return
  r = _lib.Z3_is_seq_sort(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_re_sort(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_re_sort is None:
     return
  r = _lib.Z3_mk_re_sort(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_re_sort(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_is_re_sort is None:
     return
  r = _lib.Z3_is_re_sort(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_string_sort(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_string_sort is None:
     return
  r = _lib.Z3_mk_string_sort(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_string_sort(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_is_string_sort is None:
     return
  r = _lib.Z3_is_string_sort(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_string is None:
     return
  r = _lib.Z3_mk_string(a0, _to_ascii(a1))
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_is_string is None:
     return
  r = _lib.Z3_is_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_string is None:
     return
  r = _lib.Z3_get_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_mk_seq_empty(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_empty is None:
     return
  r = _lib.Z3_mk_seq_empty(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_unit(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_unit is None:
     return
  r = _lib.Z3_mk_seq_unit(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_concat(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_concat is None:
     return
  r = _lib.Z3_mk_seq_concat(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_prefix(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_prefix is None:
     return
  r = _lib.Z3_mk_seq_prefix(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_suffix(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_suffix is None:
     return
  r = _lib.Z3_mk_seq_suffix(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_contains(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_contains is None:
     return
  r = _lib.Z3_mk_seq_contains(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_extract(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_extract is None:
     return
  r = _lib.Z3_mk_seq_extract(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_replace(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_replace is None:
     return
  r = _lib.Z3_mk_seq_replace(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_at(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_at is None:
     return
  r = _lib.Z3_mk_seq_at(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_length(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_length is None:
     return
  r = _lib.Z3_mk_seq_length(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_index(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_index is None:
     return
  r = _lib.Z3_mk_seq_index(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_mk_str_to_int(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_str_to_int is None:
     return
  r = _lib.Z3_mk_str_to_int(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_mk_int_to_str(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_int_to_str is None:
     return
  r = _lib.Z3_mk_int_to_str(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_to_re(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_to_re is None:
     return
  r = _lib.Z3_mk_seq_to_re(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_seq_in_re(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_seq_in_re is None:
     return
  r = _lib.Z3_mk_seq_in_re(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_re_plus(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_re_plus is None:
     return
  r = _lib.Z3_mk_re_plus(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_re_star(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_re_star is None:
     return
  r = _lib.Z3_mk_re_star(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_re_option(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_re_option is None:
     return
  r = _lib.Z3_mk_re_option(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_re_union(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_re_union is None:
     return
  r = _lib.Z3_mk_re_union(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_re_concat(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_re_concat is None:
     return
  r = _lib.Z3_mk_re_concat(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_mk_re_range(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_re_range is None:
     return
  r = _lib.Z3_mk_re_range(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_mk_re_loop(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_re_loop is None:
     return
  r = _lib.Z3_mk_re_loop(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_mk_re_intersect(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_re_intersect is None:
     return
  r = _lib.Z3_mk_re_intersect(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_mk_re_complement(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_re_complement is None:
     return
  r = _lib.Z3_mk_re_complement(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_mk_re_empty(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_re_empty is None:
     return
  r = _lib.Z3_mk_re_empty(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_mk_re_full(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_re_full is None:
     return
  r = _lib.Z3_mk_re_full(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_pattern(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_pattern is None:
     return
  r = _lib.Z3_mk_pattern(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_bound(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_bound is None:
     return
  r = _lib.Z3_mk_bound(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_forall(a0, a1, a2, a3, a4, a5, a6, a7):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_forall is None:
     return
  r = _lib.Z3_mk_forall(a0, a1, a2, a3, a4, a5, a6, a7)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_exists(a0, a1, a2, a3, a4, a5, a6, a7):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_exists is None:
     return
  r = _lib.Z3_mk_exists(a0, a1, a2, a3, a4, a5, a6, a7)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_quantifier(a0, a1, a2, a3, a4, a5, a6, a7, a8):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_quantifier is None:
     return
  r = _lib.Z3_mk_quantifier(a0, a1, a2, a3, a4, a5, a6, a7, a8)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_quantifier_ex(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_quantifier_ex is None:
     return
  r = _lib.Z3_mk_quantifier_ex(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_forall_const(a0, a1, a2, a3, a4, a5, a6):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_forall_const is None:
     return
  r = _lib.Z3_mk_forall_const(a0, a1, a2, a3, a4, a5, a6)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_exists_const(a0, a1, a2, a3, a4, a5, a6):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_exists_const is None:
     return
  r = _lib.Z3_mk_exists_const(a0, a1, a2, a3, a4, a5, a6)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_quantifier_const(a0, a1, a2, a3, a4, a5, a6, a7):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_quantifier_const is None:
     return
  r = _lib.Z3_mk_quantifier_const(a0, a1, a2, a3, a4, a5, a6, a7)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_quantifier_const_ex(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_quantifier_const_ex is None:
     return
  r = _lib.Z3_mk_quantifier_const_ex(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_symbol_kind(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_symbol_kind is None:
     return
  r = _lib.Z3_get_symbol_kind(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_symbol_int(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_symbol_int is None:
     return
  r = _lib.Z3_get_symbol_int(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_symbol_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_symbol_string is None:
     return
  r = _lib.Z3_get_symbol_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_get_sort_name(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_sort_name is None:
     return
  r = _lib.Z3_get_sort_name(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_sort_id(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_sort_id is None:
     return
  r = _lib.Z3_get_sort_id(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_sort_to_ast(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_sort_to_ast is None:
     return
  r = _lib.Z3_sort_to_ast(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_eq_sort(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_is_eq_sort is None:
     return
  r = _lib.Z3_is_eq_sort(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_sort_kind(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_sort_kind is None:
     return
  r = _lib.Z3_get_sort_kind(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_bv_sort_size(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_bv_sort_size is None:
     return
  r = _lib.Z3_get_bv_sort_size(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_finite_domain_sort_size(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_finite_domain_sort_size is None:
     return
  r = _lib.Z3_get_finite_domain_sort_size(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_array_sort_domain(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_array_sort_domain is None:
     return
  r = _lib.Z3_get_array_sort_domain(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_array_sort_range(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_array_sort_range is None:
     return
  r = _lib.Z3_get_array_sort_range(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_tuple_sort_mk_decl(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_tuple_sort_mk_decl is None:
     return
  r = _lib.Z3_get_tuple_sort_mk_decl(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_tuple_sort_num_fields(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_tuple_sort_num_fields is None:
     return
  r = _lib.Z3_get_tuple_sort_num_fields(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_tuple_sort_field_decl(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_tuple_sort_field_decl is None:
     return
  r = _lib.Z3_get_tuple_sort_field_decl(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_datatype_sort_num_constructors(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_datatype_sort_num_constructors is None:
     return
  r = _lib.Z3_get_datatype_sort_num_constructors(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_datatype_sort_constructor(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_datatype_sort_constructor is None:
     return
  r = _lib.Z3_get_datatype_sort_constructor(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_datatype_sort_recognizer(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_datatype_sort_recognizer is None:
     return
  r = _lib.Z3_get_datatype_sort_recognizer(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_datatype_sort_constructor_accessor(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_get_datatype_sort_constructor_accessor is None:
     return
  r = _lib.Z3_get_datatype_sort_constructor_accessor(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_datatype_update_field(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_datatype_update_field is None:
     return
  r = _lib.Z3_datatype_update_field(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_relation_arity(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_relation_arity is None:
     return
  r = _lib.Z3_get_relation_arity(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_relation_column(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_relation_column is None:
     return
  r = _lib.Z3_get_relation_column(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_atmost(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_atmost is None:
     return
  r = _lib.Z3_mk_atmost(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_mk_atleast(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_atleast is None:
     return
  r = _lib.Z3_mk_atleast(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_pble(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_pble is None:
     return
  r = _lib.Z3_mk_pble(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_mk_pbge(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_pbge is None:
     return
  r = _lib.Z3_mk_pbge(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_pbeq(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_pbeq is None:
     return
  r = _lib.Z3_mk_pbeq(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_func_decl_to_ast(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_func_decl_to_ast is None:
     return
  r = _lib.Z3_func_decl_to_ast(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_eq_func_decl(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_is_eq_func_decl is None:
     return
  r = _lib.Z3_is_eq_func_decl(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_func_decl_id(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_func_decl_id is None:
     return
  r = _lib.Z3_get_func_decl_id(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_decl_name(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_decl_name is None:
     return
  r = _lib.Z3_get_decl_name(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_decl_kind(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_decl_kind is None:
     return
  r = _lib.Z3_get_decl_kind(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_domain_size(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_domain_size is None:
     return
  r = _lib.Z3_get_domain_size(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_arity(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_arity is None:
     return
  r = _lib.Z3_get_arity(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_domain(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_domain is None:
     return
  r = _lib.Z3_get_domain(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_range(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_range is None:
     return
  r = _lib.Z3_get_range(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_decl_num_parameters(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_decl_num_parameters is None:
     return
  r = _lib.Z3_get_decl_num_parameters(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_decl_parameter_kind(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_decl_parameter_kind is None:
     return
  r = _lib.Z3_get_decl_parameter_kind(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_decl_int_parameter(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_decl_int_parameter is None:
     return
  r = _lib.Z3_get_decl_int_parameter(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_decl_double_parameter(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_decl_double_parameter is None:
     return
  r = _lib.Z3_get_decl_double_parameter(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_decl_symbol_parameter(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_decl_symbol_parameter is None:
     return
  r = _lib.Z3_get_decl_symbol_parameter(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_decl_sort_parameter(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_decl_sort_parameter is None:
     return
  r = _lib.Z3_get_decl_sort_parameter(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_decl_ast_parameter(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_decl_ast_parameter is None:
     return
  r = _lib.Z3_get_decl_ast_parameter(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_decl_func_decl_parameter(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_decl_func_decl_parameter is None:
     return
  r = _lib.Z3_get_decl_func_decl_parameter(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_decl_rational_parameter(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_decl_rational_parameter is None:
     return
  r = _lib.Z3_get_decl_rational_parameter(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_app_to_ast(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_app_to_ast is None:
     return
  r = _lib.Z3_app_to_ast(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_app_decl(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_app_decl is None:
     return
  r = _lib.Z3_get_app_decl(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_app_num_args(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_app_num_args is None:
     return
  r = _lib.Z3_get_app_num_args(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_app_arg(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_app_arg is None:
     return
  r = _lib.Z3_get_app_arg(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_eq_ast(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_is_eq_ast is None:
     return
  r = _lib.Z3_is_eq_ast(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_ast_id(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_ast_id is None:
     return
  r = _lib.Z3_get_ast_id(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_ast_hash(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_ast_hash is None:
     return
  r = _lib.Z3_get_ast_hash(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_sort(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_sort is None:
     return
  r = _lib.Z3_get_sort(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_well_sorted(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_is_well_sorted is None:
     return
  r = _lib.Z3_is_well_sorted(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_bool_value(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_bool_value is None:
     return
  r = _lib.Z3_get_bool_value(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_ast_kind(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_ast_kind is None:
     return
  r = _lib.Z3_get_ast_kind(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_app(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_is_app is None:
     return
  r = _lib.Z3_is_app(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_numeral_ast(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_is_numeral_ast is None:
     return
  r = _lib.Z3_is_numeral_ast(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_algebraic_number(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_is_algebraic_number is None:
     return
  r = _lib.Z3_is_algebraic_number(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_to_app(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_to_app is None:
     return
  r = _lib.Z3_to_app(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_to_func_decl(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_to_func_decl is None:
     return
  r = _lib.Z3_to_func_decl(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_numeral_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_numeral_string is None:
     return
  r = _lib.Z3_get_numeral_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_get_numeral_decimal_string(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_numeral_decimal_string is None:
     return
  r = _lib.Z3_get_numeral_decimal_string(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_get_numerator(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_numerator is None:
     return
  r = _lib.Z3_get_numerator(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_denominator(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_denominator is None:
     return
  r = _lib.Z3_get_denominator(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_numeral_small(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_get_numeral_small is None:
     return
  r = _lib.Z3_get_numeral_small(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_numeral_int(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_numeral_int is None:
     return
  r = _lib.Z3_get_numeral_int(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_numeral_uint(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_numeral_uint is None:
     return
  r = _lib.Z3_get_numeral_uint(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_numeral_uint64(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_numeral_uint64 is None:
     return
  r = _lib.Z3_get_numeral_uint64(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_numeral_int64(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_numeral_int64 is None:
     return
  r = _lib.Z3_get_numeral_int64(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_numeral_rational_int64(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_get_numeral_rational_int64 is None:
     return
  r = _lib.Z3_get_numeral_rational_int64(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_algebraic_number_lower(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_algebraic_number_lower is None:
     return
  r = _lib.Z3_get_algebraic_number_lower(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_algebraic_number_upper(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_algebraic_number_upper is None:
     return
  r = _lib.Z3_get_algebraic_number_upper(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_pattern_to_ast(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_pattern_to_ast is None:
     return
  r = _lib.Z3_pattern_to_ast(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_pattern_num_terms(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_pattern_num_terms is None:
     return
  r = _lib.Z3_get_pattern_num_terms(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_pattern(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_pattern is None:
     return
  r = _lib.Z3_get_pattern(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_index_value(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_index_value is None:
     return
  r = _lib.Z3_get_index_value(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_quantifier_forall(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_is_quantifier_forall is None:
     return
  r = _lib.Z3_is_quantifier_forall(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_quantifier_weight(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_quantifier_weight is None:
     return
  r = _lib.Z3_get_quantifier_weight(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_quantifier_num_patterns(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_quantifier_num_patterns is None:
     return
  r = _lib.Z3_get_quantifier_num_patterns(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_quantifier_pattern_ast(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_quantifier_pattern_ast is None:
     return
  r = _lib.Z3_get_quantifier_pattern_ast(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_quantifier_num_no_patterns(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_quantifier_num_no_patterns is None:
     return
  r = _lib.Z3_get_quantifier_num_no_patterns(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_quantifier_no_pattern_ast(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_quantifier_no_pattern_ast is None:
     return
  r = _lib.Z3_get_quantifier_no_pattern_ast(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_quantifier_num_bound(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_quantifier_num_bound is None:
     return
  r = _lib.Z3_get_quantifier_num_bound(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_quantifier_bound_name(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_quantifier_bound_name is None:
     return
  r = _lib.Z3_get_quantifier_bound_name(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_quantifier_bound_sort(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_get_quantifier_bound_sort is None:
     return
  r = _lib.Z3_get_quantifier_bound_sort(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_quantifier_body(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_quantifier_body is None:
     return
  r = _lib.Z3_get_quantifier_body(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_simplify(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_simplify is None:
     return
  r = _lib.Z3_simplify(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_simplify_ex(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_simplify_ex is None:
     return
  r = _lib.Z3_simplify_ex(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_simplify_get_help(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_simplify_get_help is None:
     return
  r = _lib.Z3_simplify_get_help(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_simplify_get_param_descrs(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_simplify_get_param_descrs is None:
     return
  r = _lib.Z3_simplify_get_param_descrs(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_update_term(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_update_term is None:
     return
  r = _lib.Z3_update_term(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_substitute(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_substitute is None:
     return
  r = _lib.Z3_substitute(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_substitute_vars(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_substitute_vars is None:
     return
  r = _lib.Z3_substitute_vars(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_translate(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_translate is None:
     return
  r = _lib.Z3_translate(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_model(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_model is None:
     return
  r = _lib.Z3_mk_model(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_model_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_model_inc_ref is None:
     return
  _lib.Z3_model_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_model_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_model_dec_ref is None:
     return
  _lib.Z3_model_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_model_eval(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_model_eval is None:
     return
  r = _lib.Z3_model_eval(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_model_get_const_interp(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_model_get_const_interp is None:
     return
  r = _lib.Z3_model_get_const_interp(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_model_has_interp(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_model_has_interp is None:
     return
  r = _lib.Z3_model_has_interp(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_model_get_func_interp(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_model_get_func_interp is None:
     return
  r = _lib.Z3_model_get_func_interp(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_model_get_num_consts(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_model_get_num_consts is None:
     return
  r = _lib.Z3_model_get_num_consts(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_model_get_const_decl(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_model_get_const_decl is None:
     return
  r = _lib.Z3_model_get_const_decl(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_model_get_num_funcs(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_model_get_num_funcs is None:
     return
  r = _lib.Z3_model_get_num_funcs(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_model_get_func_decl(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_model_get_func_decl is None:
     return
  r = _lib.Z3_model_get_func_decl(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_model_get_num_sorts(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_model_get_num_sorts is None:
     return
  r = _lib.Z3_model_get_num_sorts(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_model_get_sort(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_model_get_sort is None:
     return
  r = _lib.Z3_model_get_sort(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_model_get_sort_universe(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_model_get_sort_universe is None:
     return
  r = _lib.Z3_model_get_sort_universe(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_is_as_array(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_is_as_array is None:
     return
  r = _lib.Z3_is_as_array(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_as_array_func_decl(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_as_array_func_decl is None:
     return
  r = _lib.Z3_get_as_array_func_decl(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_add_func_interp(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_add_func_interp is None:
     return
  r = _lib.Z3_add_func_interp(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_add_const_interp(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_add_const_interp is None:
     return
  _lib.Z3_add_const_interp(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_func_interp_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_func_interp_inc_ref is None:
     return
  _lib.Z3_func_interp_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_func_interp_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_func_interp_dec_ref is None:
     return
  _lib.Z3_func_interp_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_func_interp_get_num_entries(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_func_interp_get_num_entries is None:
     return
  r = _lib.Z3_func_interp_get_num_entries(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_func_interp_get_entry(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_func_interp_get_entry is None:
     return
  r = _lib.Z3_func_interp_get_entry(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_func_interp_get_else(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_func_interp_get_else is None:
     return
  r = _lib.Z3_func_interp_get_else(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_func_interp_set_else(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_func_interp_set_else is None:
     return
  _lib.Z3_func_interp_set_else(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_func_interp_get_arity(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_func_interp_get_arity is None:
     return
  r = _lib.Z3_func_interp_get_arity(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_func_interp_add_entry(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_func_interp_add_entry is None:
     return
  _lib.Z3_func_interp_add_entry(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_func_entry_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_func_entry_inc_ref is None:
     return
  _lib.Z3_func_entry_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_func_entry_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_func_entry_dec_ref is None:
     return
  _lib.Z3_func_entry_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_func_entry_get_value(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_func_entry_get_value is None:
     return
  r = _lib.Z3_func_entry_get_value(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_func_entry_get_num_args(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_func_entry_get_num_args is None:
     return
  r = _lib.Z3_func_entry_get_num_args(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_func_entry_get_arg(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_func_entry_get_arg is None:
     return
  r = _lib.Z3_func_entry_get_arg(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_open_log(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_open_log is None:
     return
  r = _lib.Z3_open_log(_to_ascii(a0))
  return r

def Z3_append_log(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_append_log is None:
     return
  _lib.Z3_append_log(_to_ascii(a0))

def Z3_close_log():
  _lib = lib()
  if _lib is None or _lib.Z3_close_log is None:
     return
  _lib.Z3_close_log()

def Z3_toggle_warning_messages(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_toggle_warning_messages is None:
     return
  _lib.Z3_toggle_warning_messages(a0)

def Z3_set_ast_print_mode(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_set_ast_print_mode is None:
     return
  _lib.Z3_set_ast_print_mode(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_ast_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_to_string is None:
     return
  r = _lib.Z3_ast_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_pattern_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_pattern_to_string is None:
     return
  r = _lib.Z3_pattern_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_sort_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_sort_to_string is None:
     return
  r = _lib.Z3_sort_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_func_decl_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_func_decl_to_string is None:
     return
  r = _lib.Z3_func_decl_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_model_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_model_to_string is None:
     return
  r = _lib.Z3_model_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_benchmark_to_smtlib_string(a0, a1, a2, a3, a4, a5, a6, a7):
  _lib = lib()
  if _lib is None or _lib.Z3_benchmark_to_smtlib_string is None:
     return
  r = _lib.Z3_benchmark_to_smtlib_string(a0, _to_ascii(a1), _to_ascii(a2), _to_ascii(a3), _to_ascii(a4), a5, a6, a7)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_parse_smtlib2_string(a0, a1, a2, a3, a4, a5, a6, a7):
  _lib = lib()
  if _lib is None or _lib.Z3_parse_smtlib2_string is None:
     return
  r = _lib.Z3_parse_smtlib2_string(a0, _to_ascii(a1), a2, a3, a4, a5, a6, a7)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_parse_smtlib2_file(a0, a1, a2, a3, a4, a5, a6, a7):
  _lib = lib()
  if _lib is None or _lib.Z3_parse_smtlib2_file is None:
     return
  r = _lib.Z3_parse_smtlib2_file(a0, _to_ascii(a1), a2, a3, a4, a5, a6, a7)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_parse_smtlib_string(a0, a1, a2, a3, a4, a5, a6, a7):
  _lib = lib()
  if _lib is None or _lib.Z3_parse_smtlib_string is None:
     return
  _lib.Z3_parse_smtlib_string(a0, _to_ascii(a1), a2, a3, a4, a5, a6, a7)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_parse_smtlib_file(a0, a1, a2, a3, a4, a5, a6, a7):
  _lib = lib()
  if _lib is None or _lib.Z3_parse_smtlib_file is None:
     return
  _lib.Z3_parse_smtlib_file(a0, _to_ascii(a1), a2, a3, a4, a5, a6, a7)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_get_smtlib_num_formulas(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_get_smtlib_num_formulas is None:
     return
  r = _lib.Z3_get_smtlib_num_formulas(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_smtlib_formula(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_smtlib_formula is None:
     return
  r = _lib.Z3_get_smtlib_formula(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_smtlib_num_assumptions(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_get_smtlib_num_assumptions is None:
     return
  r = _lib.Z3_get_smtlib_num_assumptions(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_smtlib_assumption(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_smtlib_assumption is None:
     return
  r = _lib.Z3_get_smtlib_assumption(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_smtlib_num_decls(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_get_smtlib_num_decls is None:
     return
  r = _lib.Z3_get_smtlib_num_decls(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_smtlib_decl(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_smtlib_decl is None:
     return
  r = _lib.Z3_get_smtlib_decl(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_smtlib_num_sorts(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_get_smtlib_num_sorts is None:
     return
  r = _lib.Z3_get_smtlib_num_sorts(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_smtlib_sort(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_smtlib_sort is None:
     return
  r = _lib.Z3_get_smtlib_sort(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_smtlib_error(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_get_smtlib_error is None:
     return
  r = _lib.Z3_get_smtlib_error(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_get_error_code(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_get_error_code is None:
     return
  r = _lib.Z3_get_error_code(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_set_error(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_set_error is None:
     return
  _lib.Z3_set_error(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_get_error_msg(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_error_msg is None:
     return
  r = _lib.Z3_get_error_msg(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_get_version(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_get_version is None:
     return
  _lib.Z3_get_version(a0, a1, a2, a3)

def Z3_get_full_version():
  _lib = lib()
  if _lib is None or _lib.Z3_get_full_version is None:
     return
  r = _lib.Z3_get_full_version()
  return _to_pystr(r)

def Z3_enable_trace(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_enable_trace is None:
     return
  _lib.Z3_enable_trace(_to_ascii(a0))

def Z3_disable_trace(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_disable_trace is None:
     return
  _lib.Z3_disable_trace(_to_ascii(a0))

def Z3_reset_memory():
  _lib = lib()
  if _lib is None or _lib.Z3_reset_memory is None:
     return
  _lib.Z3_reset_memory()

def Z3_finalize_memory():
  _lib = lib()
  if _lib is None or _lib.Z3_finalize_memory is None:
     return
  _lib.Z3_finalize_memory()

def Z3_mk_goal(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_goal is None:
     return
  r = _lib.Z3_mk_goal(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_goal_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_inc_ref is None:
     return
  _lib.Z3_goal_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_goal_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_dec_ref is None:
     return
  _lib.Z3_goal_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_goal_precision(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_precision is None:
     return
  r = _lib.Z3_goal_precision(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_goal_assert(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_assert is None:
     return
  _lib.Z3_goal_assert(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_goal_inconsistent(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_inconsistent is None:
     return
  r = _lib.Z3_goal_inconsistent(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_goal_depth(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_depth is None:
     return
  r = _lib.Z3_goal_depth(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_goal_reset(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_reset is None:
     return
  _lib.Z3_goal_reset(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_goal_size(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_size is None:
     return
  r = _lib.Z3_goal_size(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_goal_formula(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_formula is None:
     return
  r = _lib.Z3_goal_formula(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_goal_num_exprs(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_num_exprs is None:
     return
  r = _lib.Z3_goal_num_exprs(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_goal_is_decided_sat(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_is_decided_sat is None:
     return
  r = _lib.Z3_goal_is_decided_sat(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_goal_is_decided_unsat(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_is_decided_unsat is None:
     return
  r = _lib.Z3_goal_is_decided_unsat(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_goal_translate(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_translate is None:
     return
  r = _lib.Z3_goal_translate(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_goal_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_goal_to_string is None:
     return
  r = _lib.Z3_goal_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_mk_tactic(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_tactic is None:
     return
  r = _lib.Z3_mk_tactic(a0, _to_ascii(a1))
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_inc_ref is None:
     return
  _lib.Z3_tactic_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_tactic_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_dec_ref is None:
     return
  _lib.Z3_tactic_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_mk_probe(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_probe is None:
     return
  r = _lib.Z3_mk_probe(a0, _to_ascii(a1))
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_probe_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_inc_ref is None:
     return
  _lib.Z3_probe_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_probe_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_dec_ref is None:
     return
  _lib.Z3_probe_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_tactic_and_then(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_and_then is None:
     return
  r = _lib.Z3_tactic_and_then(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_or_else(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_or_else is None:
     return
  r = _lib.Z3_tactic_or_else(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_par_or(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_par_or is None:
     return
  r = _lib.Z3_tactic_par_or(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_par_and_then(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_par_and_then is None:
     return
  r = _lib.Z3_tactic_par_and_then(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_try_for(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_try_for is None:
     return
  r = _lib.Z3_tactic_try_for(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_when(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_when is None:
     return
  r = _lib.Z3_tactic_when(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_cond(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_cond is None:
     return
  r = _lib.Z3_tactic_cond(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_repeat(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_repeat is None:
     return
  r = _lib.Z3_tactic_repeat(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_skip(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_skip is None:
     return
  r = _lib.Z3_tactic_skip(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_fail(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_fail is None:
     return
  r = _lib.Z3_tactic_fail(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_fail_if(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_fail_if is None:
     return
  r = _lib.Z3_tactic_fail_if(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_fail_if_not_decided(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_fail_if_not_decided is None:
     return
  r = _lib.Z3_tactic_fail_if_not_decided(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_using_params(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_using_params is None:
     return
  r = _lib.Z3_tactic_using_params(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_probe_const(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_const is None:
     return
  r = _lib.Z3_probe_const(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_probe_lt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_lt is None:
     return
  r = _lib.Z3_probe_lt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_probe_gt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_gt is None:
     return
  r = _lib.Z3_probe_gt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_probe_le(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_le is None:
     return
  r = _lib.Z3_probe_le(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_probe_ge(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_ge is None:
     return
  r = _lib.Z3_probe_ge(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_probe_eq(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_eq is None:
     return
  r = _lib.Z3_probe_eq(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_probe_and(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_and is None:
     return
  r = _lib.Z3_probe_and(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_probe_or(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_or is None:
     return
  r = _lib.Z3_probe_or(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_probe_not(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_not is None:
     return
  r = _lib.Z3_probe_not(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_num_tactics(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_get_num_tactics is None:
     return
  r = _lib.Z3_get_num_tactics(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_tactic_name(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_tactic_name is None:
     return
  r = _lib.Z3_get_tactic_name(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_get_num_probes(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_get_num_probes is None:
     return
  r = _lib.Z3_get_num_probes(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_probe_name(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_get_probe_name is None:
     return
  r = _lib.Z3_get_probe_name(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_tactic_get_help(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_get_help is None:
     return
  r = _lib.Z3_tactic_get_help(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_tactic_get_param_descrs(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_get_param_descrs is None:
     return
  r = _lib.Z3_tactic_get_param_descrs(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_get_descr(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_get_descr is None:
     return
  r = _lib.Z3_tactic_get_descr(a0, _to_ascii(a1))
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_probe_get_descr(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_get_descr is None:
     return
  r = _lib.Z3_probe_get_descr(a0, _to_ascii(a1))
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_probe_apply(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_probe_apply is None:
     return
  r = _lib.Z3_probe_apply(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_apply(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_apply is None:
     return
  r = _lib.Z3_tactic_apply(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_tactic_apply_ex(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_tactic_apply_ex is None:
     return
  r = _lib.Z3_tactic_apply_ex(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_apply_result_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_apply_result_inc_ref is None:
     return
  _lib.Z3_apply_result_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_apply_result_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_apply_result_dec_ref is None:
     return
  _lib.Z3_apply_result_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_apply_result_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_apply_result_to_string is None:
     return
  r = _lib.Z3_apply_result_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_apply_result_get_num_subgoals(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_apply_result_get_num_subgoals is None:
     return
  r = _lib.Z3_apply_result_get_num_subgoals(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_apply_result_get_subgoal(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_apply_result_get_subgoal is None:
     return
  r = _lib.Z3_apply_result_get_subgoal(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_apply_result_convert_model(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_apply_result_convert_model is None:
     return
  r = _lib.Z3_apply_result_convert_model(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_solver(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_solver is None:
     return
  r = _lib.Z3_mk_solver(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_simple_solver(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_simple_solver is None:
     return
  r = _lib.Z3_mk_simple_solver(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_solver_for_logic(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_solver_for_logic is None:
     return
  r = _lib.Z3_mk_solver_for_logic(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_solver_from_tactic(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_solver_from_tactic is None:
     return
  r = _lib.Z3_mk_solver_from_tactic(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_solver_translate(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_translate is None:
     return
  r = _lib.Z3_solver_translate(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_solver_get_help(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_get_help is None:
     return
  r = _lib.Z3_solver_get_help(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_solver_get_param_descrs(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_get_param_descrs is None:
     return
  r = _lib.Z3_solver_get_param_descrs(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_solver_set_params(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_set_params is None:
     return
  _lib.Z3_solver_set_params(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_solver_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_inc_ref is None:
     return
  _lib.Z3_solver_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_solver_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_dec_ref is None:
     return
  _lib.Z3_solver_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_solver_push(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_push is None:
     return
  _lib.Z3_solver_push(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_solver_pop(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_pop is None:
     return
  _lib.Z3_solver_pop(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_solver_reset(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_reset is None:
     return
  _lib.Z3_solver_reset(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_solver_get_num_scopes(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_get_num_scopes is None:
     return
  r = _lib.Z3_solver_get_num_scopes(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_solver_assert(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_assert is None:
     return
  _lib.Z3_solver_assert(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_solver_assert_and_track(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_assert_and_track is None:
     return
  _lib.Z3_solver_assert_and_track(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_solver_get_assertions(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_get_assertions is None:
     return
  r = _lib.Z3_solver_get_assertions(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_solver_check(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_check is None:
     return
  r = _lib.Z3_solver_check(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_solver_check_assumptions(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_check_assumptions is None:
     return
  r = _lib.Z3_solver_check_assumptions(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_implied_equalities(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_get_implied_equalities is None:
     return
  r = _lib.Z3_get_implied_equalities(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_solver_get_consequences(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_get_consequences is None:
     return
  r = _lib.Z3_solver_get_consequences(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_solver_get_model(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_get_model is None:
     return
  r = _lib.Z3_solver_get_model(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_solver_get_proof(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_get_proof is None:
     return
  r = _lib.Z3_solver_get_proof(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_solver_get_unsat_core(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_get_unsat_core is None:
     return
  r = _lib.Z3_solver_get_unsat_core(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_solver_get_reason_unknown(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_get_reason_unknown is None:
     return
  r = _lib.Z3_solver_get_reason_unknown(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_solver_get_statistics(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_get_statistics is None:
     return
  r = _lib.Z3_solver_get_statistics(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_solver_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_solver_to_string is None:
     return
  r = _lib.Z3_solver_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_stats_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_stats_to_string is None:
     return
  r = _lib.Z3_stats_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_stats_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_stats_inc_ref is None:
     return
  _lib.Z3_stats_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_stats_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_stats_dec_ref is None:
     return
  _lib.Z3_stats_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_stats_size(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_stats_size is None:
     return
  r = _lib.Z3_stats_size(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_stats_get_key(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_stats_get_key is None:
     return
  r = _lib.Z3_stats_get_key(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_stats_is_uint(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_stats_is_uint is None:
     return
  r = _lib.Z3_stats_is_uint(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_stats_is_double(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_stats_is_double is None:
     return
  r = _lib.Z3_stats_is_double(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_stats_get_uint_value(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_stats_get_uint_value is None:
     return
  r = _lib.Z3_stats_get_uint_value(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_stats_get_double_value(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_stats_get_double_value is None:
     return
  r = _lib.Z3_stats_get_double_value(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_get_estimated_alloc_size():
  _lib = lib()
  if _lib is None or _lib.Z3_get_estimated_alloc_size is None:
     return
  r = _lib.Z3_get_estimated_alloc_size()
  return r

def Z3_mk_ast_vector(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_ast_vector is None:
     return
  r = _lib.Z3_mk_ast_vector(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_ast_vector_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_vector_inc_ref is None:
     return
  _lib.Z3_ast_vector_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_ast_vector_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_vector_dec_ref is None:
     return
  _lib.Z3_ast_vector_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_ast_vector_size(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_vector_size is None:
     return
  r = _lib.Z3_ast_vector_size(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_ast_vector_get(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_vector_get is None:
     return
  r = _lib.Z3_ast_vector_get(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_ast_vector_set(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_vector_set is None:
     return
  _lib.Z3_ast_vector_set(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_ast_vector_resize(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_vector_resize is None:
     return
  _lib.Z3_ast_vector_resize(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_ast_vector_push(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_vector_push is None:
     return
  _lib.Z3_ast_vector_push(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_ast_vector_translate(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_vector_translate is None:
     return
  r = _lib.Z3_ast_vector_translate(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_ast_vector_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_vector_to_string is None:
     return
  r = _lib.Z3_ast_vector_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_mk_ast_map(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_ast_map is None:
     return
  r = _lib.Z3_mk_ast_map(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_ast_map_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_map_inc_ref is None:
     return
  _lib.Z3_ast_map_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_ast_map_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_map_dec_ref is None:
     return
  _lib.Z3_ast_map_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_ast_map_contains(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_map_contains is None:
     return
  r = _lib.Z3_ast_map_contains(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_ast_map_find(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_map_find is None:
     return
  r = _lib.Z3_ast_map_find(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_ast_map_insert(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_map_insert is None:
     return
  _lib.Z3_ast_map_insert(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_ast_map_erase(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_map_erase is None:
     return
  _lib.Z3_ast_map_erase(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_ast_map_reset(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_map_reset is None:
     return
  _lib.Z3_ast_map_reset(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_ast_map_size(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_map_size is None:
     return
  r = _lib.Z3_ast_map_size(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_ast_map_keys(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_map_keys is None:
     return
  r = _lib.Z3_ast_map_keys(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_ast_map_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_ast_map_to_string is None:
     return
  r = _lib.Z3_ast_map_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_algebraic_is_value(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_is_value is None:
     return
  r = _lib.Z3_algebraic_is_value(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_is_pos(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_is_pos is None:
     return
  r = _lib.Z3_algebraic_is_pos(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_is_neg(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_is_neg is None:
     return
  r = _lib.Z3_algebraic_is_neg(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_is_zero(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_is_zero is None:
     return
  r = _lib.Z3_algebraic_is_zero(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_sign(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_sign is None:
     return
  r = _lib.Z3_algebraic_sign(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_add(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_add is None:
     return
  r = _lib.Z3_algebraic_add(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_sub(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_sub is None:
     return
  r = _lib.Z3_algebraic_sub(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_mul(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_mul is None:
     return
  r = _lib.Z3_algebraic_mul(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_div(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_div is None:
     return
  r = _lib.Z3_algebraic_div(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_root(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_root is None:
     return
  r = _lib.Z3_algebraic_root(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_power(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_power is None:
     return
  r = _lib.Z3_algebraic_power(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_lt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_lt is None:
     return
  r = _lib.Z3_algebraic_lt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_gt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_gt is None:
     return
  r = _lib.Z3_algebraic_gt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_le(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_le is None:
     return
  r = _lib.Z3_algebraic_le(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_ge(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_ge is None:
     return
  r = _lib.Z3_algebraic_ge(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_eq(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_eq is None:
     return
  r = _lib.Z3_algebraic_eq(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_neq(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_neq is None:
     return
  r = _lib.Z3_algebraic_neq(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_roots(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_roots is None:
     return
  r = _lib.Z3_algebraic_roots(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_algebraic_eval(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_algebraic_eval is None:
     return
  r = _lib.Z3_algebraic_eval(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_polynomial_subresultants(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_polynomial_subresultants is None:
     return
  r = _lib.Z3_polynomial_subresultants(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_del(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_del is None:
     return
  _lib.Z3_rcf_del(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_rcf_mk_rational(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_mk_rational is None:
     return
  r = _lib.Z3_rcf_mk_rational(a0, _to_ascii(a1))
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_mk_small_int(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_mk_small_int is None:
     return
  r = _lib.Z3_rcf_mk_small_int(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_mk_pi(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_mk_pi is None:
     return
  r = _lib.Z3_rcf_mk_pi(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_mk_e(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_mk_e is None:
     return
  r = _lib.Z3_rcf_mk_e(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_mk_infinitesimal(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_mk_infinitesimal is None:
     return
  r = _lib.Z3_rcf_mk_infinitesimal(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_mk_roots(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_mk_roots is None:
     return
  r = _lib.Z3_rcf_mk_roots(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_add(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_add is None:
     return
  r = _lib.Z3_rcf_add(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_sub(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_sub is None:
     return
  r = _lib.Z3_rcf_sub(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_mul(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_mul is None:
     return
  r = _lib.Z3_rcf_mul(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_div(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_div is None:
     return
  r = _lib.Z3_rcf_div(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_neg(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_neg is None:
     return
  r = _lib.Z3_rcf_neg(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_inv(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_inv is None:
     return
  r = _lib.Z3_rcf_inv(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_power(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_power is None:
     return
  r = _lib.Z3_rcf_power(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_lt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_lt is None:
     return
  r = _lib.Z3_rcf_lt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_gt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_gt is None:
     return
  r = _lib.Z3_rcf_gt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_le(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_le is None:
     return
  r = _lib.Z3_rcf_le(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_ge(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_ge is None:
     return
  r = _lib.Z3_rcf_ge(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_eq(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_eq is None:
     return
  r = _lib.Z3_rcf_eq(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_neq(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_neq is None:
     return
  r = _lib.Z3_rcf_neq(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_rcf_num_to_string(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_num_to_string is None:
     return
  r = _lib.Z3_rcf_num_to_string(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_rcf_num_to_decimal_string(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_num_to_decimal_string is None:
     return
  r = _lib.Z3_rcf_num_to_decimal_string(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_rcf_get_numerator_denominator(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_rcf_get_numerator_denominator is None:
     return
  _lib.Z3_rcf_get_numerator_denominator(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_mk_fixedpoint(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fixedpoint is None:
     return
  r = _lib.Z3_mk_fixedpoint(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_inc_ref is None:
     return
  _lib.Z3_fixedpoint_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_fixedpoint_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_dec_ref is None:
     return
  _lib.Z3_fixedpoint_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_fixedpoint_add_rule(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_add_rule is None:
     return
  _lib.Z3_fixedpoint_add_rule(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_fixedpoint_add_fact(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_add_fact is None:
     return
  _lib.Z3_fixedpoint_add_fact(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_fixedpoint_assert(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_assert is None:
     return
  _lib.Z3_fixedpoint_assert(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_fixedpoint_query(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_query is None:
     return
  r = _lib.Z3_fixedpoint_query(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_query_relations(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_query_relations is None:
     return
  r = _lib.Z3_fixedpoint_query_relations(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_get_answer(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_answer is None:
     return
  r = _lib.Z3_fixedpoint_get_answer(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_get_reason_unknown(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_reason_unknown is None:
     return
  r = _lib.Z3_fixedpoint_get_reason_unknown(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_fixedpoint_update_rule(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_update_rule is None:
     return
  _lib.Z3_fixedpoint_update_rule(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_fixedpoint_get_num_levels(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_num_levels is None:
     return
  r = _lib.Z3_fixedpoint_get_num_levels(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_get_cover_delta(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_cover_delta is None:
     return
  r = _lib.Z3_fixedpoint_get_cover_delta(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_add_cover(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_add_cover is None:
     return
  _lib.Z3_fixedpoint_add_cover(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_fixedpoint_get_statistics(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_statistics is None:
     return
  r = _lib.Z3_fixedpoint_get_statistics(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_register_relation(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_register_relation is None:
     return
  _lib.Z3_fixedpoint_register_relation(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_fixedpoint_set_predicate_representation(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_set_predicate_representation is None:
     return
  _lib.Z3_fixedpoint_set_predicate_representation(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_fixedpoint_get_rules(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_rules is None:
     return
  r = _lib.Z3_fixedpoint_get_rules(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_get_assertions(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_assertions is None:
     return
  r = _lib.Z3_fixedpoint_get_assertions(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_set_params(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_set_params is None:
     return
  _lib.Z3_fixedpoint_set_params(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_fixedpoint_get_help(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_help is None:
     return
  r = _lib.Z3_fixedpoint_get_help(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_fixedpoint_get_param_descrs(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_param_descrs is None:
     return
  r = _lib.Z3_fixedpoint_get_param_descrs(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_to_string(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_to_string is None:
     return
  r = _lib.Z3_fixedpoint_to_string(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_fixedpoint_from_string(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_from_string is None:
     return
  r = _lib.Z3_fixedpoint_from_string(a0, a1, _to_ascii(a2))
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_from_file(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_from_file is None:
     return
  r = _lib.Z3_fixedpoint_from_file(a0, a1, _to_ascii(a2))
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_push(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_push is None:
     return
  _lib.Z3_fixedpoint_push(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_fixedpoint_pop(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_pop is None:
     return
  _lib.Z3_fixedpoint_pop(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_mk_optimize(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_optimize is None:
     return
  r = _lib.Z3_mk_optimize(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_inc_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_inc_ref is None:
     return
  _lib.Z3_optimize_inc_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_optimize_dec_ref(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_dec_ref is None:
     return
  _lib.Z3_optimize_dec_ref(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_optimize_assert(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_assert is None:
     return
  _lib.Z3_optimize_assert(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_optimize_assert_soft(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_assert_soft is None:
     return
  r = _lib.Z3_optimize_assert_soft(a0, a1, a2, _to_ascii(a3), a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_maximize(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_maximize is None:
     return
  r = _lib.Z3_optimize_maximize(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_minimize(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_minimize is None:
     return
  r = _lib.Z3_optimize_minimize(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_push(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_push is None:
     return
  _lib.Z3_optimize_push(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_optimize_pop(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_pop is None:
     return
  _lib.Z3_optimize_pop(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_optimize_check(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_check is None:
     return
  r = _lib.Z3_optimize_check(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_get_reason_unknown(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_get_reason_unknown is None:
     return
  r = _lib.Z3_optimize_get_reason_unknown(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_optimize_get_model(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_get_model is None:
     return
  r = _lib.Z3_optimize_get_model(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_set_params(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_set_params is None:
     return
  _lib.Z3_optimize_set_params(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_optimize_get_param_descrs(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_get_param_descrs is None:
     return
  r = _lib.Z3_optimize_get_param_descrs(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_get_lower(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_get_lower is None:
     return
  r = _lib.Z3_optimize_get_lower(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_get_upper(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_get_upper is None:
     return
  r = _lib.Z3_optimize_get_upper(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_optimize_get_lower_as_vector(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_get_lower_as_vector is None:
     return
  r = _lib.Z3_optimize_get_lower_as_vector(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_optimize_get_upper_as_vector(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_get_upper_as_vector is None:
     return
  r = _lib.Z3_optimize_get_upper_as_vector(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_to_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_to_string is None:
     return
  r = _lib.Z3_optimize_to_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_optimize_from_string(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_from_string is None:
     return
  _lib.Z3_optimize_from_string(a0, a1, _to_ascii(a2))
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_optimize_from_file(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_from_file is None:
     return
  _lib.Z3_optimize_from_file(a0, a1, _to_ascii(a2))
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_optimize_get_help(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_get_help is None:
     return
  r = _lib.Z3_optimize_get_help(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_optimize_get_statistics(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_get_statistics is None:
     return
  r = _lib.Z3_optimize_get_statistics(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_get_assertions(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_get_assertions is None:
     return
  r = _lib.Z3_optimize_get_assertions(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_optimize_get_objectives(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_optimize_get_objectives is None:
     return
  r = _lib.Z3_optimize_get_objectives(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_interpolant(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_interpolant is None:
     return
  r = _lib.Z3_mk_interpolant(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_interpolation_context(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_interpolation_context is None:
     return
  r = _lib.Z3_mk_interpolation_context(a0)
  return r

def Z3_get_interpolant(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_get_interpolant is None:
     return
  r = _lib.Z3_get_interpolant(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_compute_interpolant(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_compute_interpolant is None:
     return
  r = _lib.Z3_compute_interpolant(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_interpolation_profile(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_interpolation_profile is None:
     return
  r = _lib.Z3_interpolation_profile(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_read_interpolation_problem(a0, a1, a2, a3, a4, a5, a6, a7):
  _lib = lib()
  if _lib is None or _lib.Z3_read_interpolation_problem is None:
     return
  r = _lib.Z3_read_interpolation_problem(a0, a1, a2, a3, _to_ascii(a4), _to_ascii(a5), a6, a7)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_check_interpolant(a0, a1, a2, a3, a4, a5, a6, a7):
  _lib = lib()
  if _lib is None or _lib.Z3_check_interpolant is None:
     return
  r = _lib.Z3_check_interpolant(a0, a1, a2, a3, a4, _to_ascii(a5), a6, a7)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_write_interpolation_problem(a0, a1, a2, a3, a4, a5, a6):
  _lib = lib()
  if _lib is None or _lib.Z3_write_interpolation_problem is None:
     return
  _lib.Z3_write_interpolation_problem(a0, a1, a2, a3, _to_ascii(a4), a5, a6)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
...
def Z3_mk_fpa_rounding_mode_sort(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_rounding_mode_sort is None:
     return
  r = _lib.Z3_mk_fpa_rounding_mode_sort(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_round_nearest_ties_to_even(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_round_nearest_ties_to_even is None:
     return
  r = _lib.Z3_mk_fpa_round_nearest_ties_to_even(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_rne(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_rne is None:
     return
  r = _lib.Z3_mk_fpa_rne(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_round_nearest_ties_to_away(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_round_nearest_ties_to_away is None:
     return
  r = _lib.Z3_mk_fpa_round_nearest_ties_to_away(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_rna(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_rna is None:
     return
  r = _lib.Z3_mk_fpa_rna(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_round_toward_positive(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_round_toward_positive is None:
     return
  r = _lib.Z3_mk_fpa_round_toward_positive(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_rtp(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_rtp is None:
     return
  r = _lib.Z3_mk_fpa_rtp(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_round_toward_negative(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_round_toward_negative is None:
     return
  r = _lib.Z3_mk_fpa_round_toward_negative(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_rtn(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_rtn is None:
     return
  r = _lib.Z3_mk_fpa_rtn(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_round_toward_zero(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_round_toward_zero is None:
     return
  r = _lib.Z3_mk_fpa_round_toward_zero(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_rtz(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_rtz is None:
     return
  r = _lib.Z3_mk_fpa_rtz(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_sort(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_sort is None:
     return
  r = _lib.Z3_mk_fpa_sort(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_sort_half(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_sort_half is None:
     return
  r = _lib.Z3_mk_fpa_sort_half(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_sort_16(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_sort_16 is None:
     return
  r = _lib.Z3_mk_fpa_sort_16(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_sort_single(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_sort_single is None:
     return
  r = _lib.Z3_mk_fpa_sort_single(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_sort_32(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_sort_32 is None:
     return
  r = _lib.Z3_mk_fpa_sort_32(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_sort_double(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_sort_double is None:
     return
  r = _lib.Z3_mk_fpa_sort_double(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_sort_64(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_sort_64 is None:
     return
  r = _lib.Z3_mk_fpa_sort_64(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_sort_quadruple(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_sort_quadruple is None:
     return
  r = _lib.Z3_mk_fpa_sort_quadruple(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_sort_128(a0):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_sort_128 is None:
     return
  r = _lib.Z3_mk_fpa_sort_128(a0)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_nan(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_nan is None:
     return
  r = _lib.Z3_mk_fpa_nan(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_inf(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_inf is None:
     return
  r = _lib.Z3_mk_fpa_inf(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_zero(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_zero is None:
     return
  r = _lib.Z3_mk_fpa_zero(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_fp(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_fp is None:
     return
  r = _lib.Z3_mk_fpa_fp(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_numeral_float(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_numeral_float is None:
     return
  r = _lib.Z3_mk_fpa_numeral_float(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_numeral_double(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_numeral_double is None:
     return
  r = _lib.Z3_mk_fpa_numeral_double(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_numeral_int(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_numeral_int is None:
     return
  r = _lib.Z3_mk_fpa_numeral_int(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_numeral_int_uint(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_numeral_int_uint is None:
     return
  r = _lib.Z3_mk_fpa_numeral_int_uint(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_numeral_int64_uint64(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_numeral_int64_uint64 is None:
     return
  r = _lib.Z3_mk_fpa_numeral_int64_uint64(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_abs(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_abs is None:
     return
  r = _lib.Z3_mk_fpa_abs(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_neg(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_neg is None:
     return
  r = _lib.Z3_mk_fpa_neg(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_add(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_add is None:
     return
  r = _lib.Z3_mk_fpa_add(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_sub(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_sub is None:
     return
  r = _lib.Z3_mk_fpa_sub(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_mul(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_mul is None:
     return
  r = _lib.Z3_mk_fpa_mul(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_div(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_div is None:
     return
  r = _lib.Z3_mk_fpa_div(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_fma(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_fma is None:
     return
  r = _lib.Z3_mk_fpa_fma(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_sqrt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_sqrt is None:
     return
  r = _lib.Z3_mk_fpa_sqrt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_rem(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_rem is None:
     return
  r = _lib.Z3_mk_fpa_rem(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_round_to_integral(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_round_to_integral is None:
     return
  r = _lib.Z3_mk_fpa_round_to_integral(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_min(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_min is None:
     return
  r = _lib.Z3_mk_fpa_min(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_max(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_max is None:
     return
  r = _lib.Z3_mk_fpa_max(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_leq(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_leq is None:
     return
  r = _lib.Z3_mk_fpa_leq(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_lt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_lt is None:
     return
  r = _lib.Z3_mk_fpa_lt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_geq(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_geq is None:
     return
  r = _lib.Z3_mk_fpa_geq(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_gt(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_gt is None:
     return
  r = _lib.Z3_mk_fpa_gt(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_eq(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_eq is None:
     return
  r = _lib.Z3_mk_fpa_eq(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_is_normal(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_is_normal is None:
     return
  r = _lib.Z3_mk_fpa_is_normal(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_is_subnormal(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_is_subnormal is None:
     return
  r = _lib.Z3_mk_fpa_is_subnormal(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_is_zero(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_is_zero is None:
     return
  r = _lib.Z3_mk_fpa_is_zero(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_is_infinite(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_is_infinite is None:
     return
  r = _lib.Z3_mk_fpa_is_infinite(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_is_nan(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_is_nan is None:
     return
  r = _lib.Z3_mk_fpa_is_nan(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_is_negative(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_is_negative is None:
     return
  r = _lib.Z3_mk_fpa_is_negative(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_is_positive(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_is_positive is None:
     return
  r = _lib.Z3_mk_fpa_is_positive(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_to_fp_bv(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_to_fp_bv is None:
     return
  r = _lib.Z3_mk_fpa_to_fp_bv(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_to_fp_float(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_to_fp_float is None:
     return
  r = _lib.Z3_mk_fpa_to_fp_float(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_to_fp_real(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_to_fp_real is None:
     return
  r = _lib.Z3_mk_fpa_to_fp_real(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_to_fp_signed(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_to_fp_signed is None:
     return
  r = _lib.Z3_mk_fpa_to_fp_signed(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_to_fp_unsigned(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_to_fp_unsigned is None:
     return
  r = _lib.Z3_mk_fpa_to_fp_unsigned(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_to_ubv(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_to_ubv is None:
     return
  r = _lib.Z3_mk_fpa_to_ubv(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_to_sbv(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_to_sbv is None:
     return
  r = _lib.Z3_mk_fpa_to_sbv(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_to_real(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_to_real is None:
     return
  r = _lib.Z3_mk_fpa_to_real(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_get_ebits(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_get_ebits is None:
     return
  r = _lib.Z3_fpa_get_ebits(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_get_sbits(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_get_sbits is None:
     return
  r = _lib.Z3_fpa_get_sbits(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_fpa_is_numeral_nan(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_is_numeral_nan is None:
     return
  r = _lib.Z3_fpa_is_numeral_nan(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_fpa_is_numeral_inf(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_is_numeral_inf is None:
     return
  r = _lib.Z3_fpa_is_numeral_inf(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_fpa_is_numeral_zero(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_is_numeral_zero is None:
     return
  r = _lib.Z3_fpa_is_numeral_zero(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_fpa_is_numeral_normal(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_is_numeral_normal is None:
     return
  r = _lib.Z3_fpa_is_numeral_normal(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_fpa_is_numeral_subnormal(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_is_numeral_subnormal is None:
     return
  r = _lib.Z3_fpa_is_numeral_subnormal(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_fpa_is_numeral_positive(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_is_numeral_positive is None:
     return
  r = _lib.Z3_fpa_is_numeral_positive(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_fpa_is_numeral_negative(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_is_numeral_negative is None:
     return
  r = _lib.Z3_fpa_is_numeral_negative(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_fpa_get_numeral_sign_bv(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_get_numeral_sign_bv is None:
     return
  r = _lib.Z3_fpa_get_numeral_sign_bv(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_fpa_get_numeral_significand_bv(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_get_numeral_significand_bv is None:
     return
  r = _lib.Z3_fpa_get_numeral_significand_bv(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_get_numeral_sign(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_get_numeral_sign is None:
     return
  r = _lib.Z3_fpa_get_numeral_sign(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fpa_get_numeral_significand_string(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_get_numeral_significand_string is None:
     return
  r = _lib.Z3_fpa_get_numeral_significand_string(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)
...
def Z3_fpa_get_numeral_significand_uint64(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_get_numeral_significand_uint64 is None:
     return
  r = _lib.Z3_fpa_get_numeral_significand_uint64(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_fpa_get_numeral_exponent_string(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_get_numeral_exponent_string is None:
     return
  r = _lib.Z3_fpa_get_numeral_exponent_string(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return _to_pystr(r)

def Z3_fpa_get_numeral_exponent_int64(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_get_numeral_exponent_int64 is None:
     return
  r = _lib.Z3_fpa_get_numeral_exponent_int64(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_fpa_get_numeral_exponent_bv(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_fpa_get_numeral_exponent_bv is None:
     return
  r = _lib.Z3_fpa_get_numeral_exponent_bv(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_to_ieee_bv(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_to_ieee_bv is None:
     return
  r = _lib.Z3_mk_fpa_to_ieee_bv(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_mk_fpa_to_fp_int_real(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_mk_fpa_to_fp_int_real is None:
     return
  r = _lib.Z3_mk_fpa_to_fp_int_real(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_query_from_lvl(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_query_from_lvl is None:
     return
  r = _lib.Z3_fixedpoint_query_from_lvl(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_get_ground_sat_answer(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_ground_sat_answer is None:
     return
  r = _lib.Z3_fixedpoint_get_ground_sat_answer(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_get_rules_along_trace(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_rules_along_trace is None:
     return
  r = _lib.Z3_fixedpoint_get_rules_along_trace(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_fixedpoint_get_rule_names_along_trace(a0, a1):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_rule_names_along_trace is None:
     return
  r = _lib.Z3_fixedpoint_get_rule_names_along_trace(a0, a1)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r

def Z3_fixedpoint_add_invariant(a0, a1, a2, a3):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_add_invariant is None:
     return
  _lib.Z3_fixedpoint_add_invariant(a0, a1, a2, a3)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))

def Z3_fixedpoint_get_reachable(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_fixedpoint_get_reachable is None:
     return
  r = _lib.Z3_fixedpoint_get_reachable(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_qe_model_project(a0, a1, a2, a3, a4):
  _lib = lib()
  if _lib is None or _lib.Z3_qe_model_project is None:
     return
  r = _lib.Z3_qe_model_project(a0, a1, a2, a3, a4)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_qe_model_project_skolem(a0, a1, a2, a3, a4, a5):
  _lib = lib()
  if _lib is None or _lib.Z3_qe_model_project_skolem is None:
     return
  r = _lib.Z3_qe_model_project_skolem(a0, a1, a2, a3, a4, a5)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_model_extrapolate(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_model_extrapolate is None:
     return
  r = _lib.Z3_model_extrapolate(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
...
def Z3_qe_lite(a0, a1, a2):
  _lib = lib()
  if _lib is None or _lib.Z3_qe_lite is None:
     return
  r = _lib.Z3_qe_lite(a0, a1, a2)
  err = _lib.Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(_lib.Z3_get_error_msg(a0, err))
  return r
