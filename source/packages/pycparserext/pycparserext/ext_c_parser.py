...
import pycparser1.c_parser
import pycparser1.c_ast as c_ast
try:
    import pycparser1.ply.yacc as yacc
except ImportError:
    import ply.yacc as yacc
from pycparser1.plyparser import parameterized, template


class CParserBase(pycparser1.c_parser.CParser):
    def __init__(self, **kwds):
        kwds['lexer'] = self.lexer_class
        kwds['lextab'] = 'pycparserext.lextab'
        kwds['yacctab'] = 'pycparserext.yacctab'
        pycparser1.c_parser.CParser.__init__(self, **kwds)
